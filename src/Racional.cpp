...
{
	int num= this->numerador*fraccion.denominador;
	int den= this->denominador*fraccion.numerador;

	Racional ra(num,den);
	return ra;

}
Raccion Racional::multiplicar(Racional fraccion)
{
    int num = this->numerador*fraccion.numerador;
